...
namespace GalacticraftPM\DemonicDev\World\Generators\Moon\populator;
...
use GalacticraftPM\DemonicDev\World\Generators\Moon\BiomeFactory;
class MoonSurfacePopulator
{
