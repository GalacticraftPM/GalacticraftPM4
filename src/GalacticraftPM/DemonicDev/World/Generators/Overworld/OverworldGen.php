...
use GalacticraftPM\DemonicDev\World\Generators\Overworld\populator\impl\CarvePopulator;
use GalacticraftPM\DemonicDev\World\Generators\Overworld\populator\impl\GroundCoverPopulator;
...
class OverworldGen extends Generator {
	...
	public function __construct(int $seed, string $preset) {
		...
		$ores->setOreTypes([
			...
			new OreType(CustomiesBlockFactory::getInstance()->get("customies:copper_ore"), $stone, 24, 8, 0, 75),
			new OreType(CustomiesBlockFactory::getInstance()->get("customies:tin_ore"), $stone, 22, 8, 0, 60),
			new OreType(CustomiesBlockFactory::getInstance()->get("customies:aluminium_ore"), $stone, 18, 8, 0, 45),
			new OreType(CustomiesBlockFactory::getInstance()->get("customies:silicon_ore"), $stone, 3, 8, 0, 25),
